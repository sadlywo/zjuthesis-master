...
%%\titletwolines{刚柔耦合连续体结构的分布式多模态}{自感知与三维形态估计方法研究} \titleengtwolines{English Title Line One}{English Title Line Two}
 \titlethreelines{刚柔耦合连续体结构的}{分布式多模态自感知}{与三维形态估计方法研究}
